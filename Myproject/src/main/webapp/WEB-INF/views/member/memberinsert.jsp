...
<script>
  if (document.location.search.match(/type=embed/gi)) {
	...
	<h1 style="background-color:gray;color: white;text-shadow : 2px 2px 5px black;" align="center">계산교회 청년부 DTS</h1>
		...
		<h2 style="border:1px solid black;border-left:#55555B 10px solid;border-right:#55555B 10px solid;" align="center">훈련생입력</h2>
		<div align="center">	
		<table class="table">
		<tr>
		...
		<form action="memberinsert" method="post">
			...
			<br>
			<br>
			<input class="button2" type="submit" value="입력하기">
		</form>
		</div>
