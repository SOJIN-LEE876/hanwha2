...
<link rel="stylesheet" href="/myapp/resources/css/bootstrap.css">
		<script>
			function call(){
				location.href="assignmentinsert";
			}
		</script>
		 <style>
...
<script>
  if (document.location.search.match(/type=embed/gi)) {
	...
	<br>
		...
		<h2 style="border:1px solid black;border-left:#55555B 10px solid;border-right:#55555B 10px solid;" align="center">${name} 과제 수행 목록</h2>
		<div align="center">
		<!-- <button onclick="call();">과제 제출</button> -->
		</div>
		<hr>
		<div align="center">
		<table class="table">
